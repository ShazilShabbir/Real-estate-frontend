...
const PropertyMap = nextDynamic(() => import("@/components/property-map"), { ssr: false })
...
function PropertiesContent() {
  ...
  const onFilterChange = (newFilters: Record<string, string | number | undefined>) => {
  ...
  const isLiked = (propertyId: string | number): boolean => {
